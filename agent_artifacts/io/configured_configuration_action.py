...
from agent_artifacts.application.configuration_edit import (
    ConfigurationEdit,
    plan_configuration_edit,
)
from agent_artifacts.application.consumer_session import ConsumerMachine, InstalledInspection
from agent_artifacts.application.execution import LifecycleExecutionOutcome, execute_lifecycle
from agent_artifacts.application.intents import (
    LifecyclePlan,
    configure_intent,
    plan_lifecycle_intent,
)
from agent_artifacts.application.receipt_recording import RecordedOutcome, record_lifecycle_outcome
