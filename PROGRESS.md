...
| RR-8 | The `2.6.0` release commit | done | Version `2.6.0`, contract v14: compatibility, checklist, notes. The freeze claim is verified rather than asserted — identical `protocol_versions`, one differing input |
...
docs/release/release-checklist-v12.md.
