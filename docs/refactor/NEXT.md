...
`fix/registry-provide-aart-posix-sh`, which is **in review as PR #21 and is being released** — do
not commit to it, do not rebase onto `main` until that PR merges. After it merges, rebase this
branch onto the released `main` and continue.
