...
| CP-04 Authoring manifest/compiler | IN PROGRESS | Slice opened; existing native protocol/compiler characterized | Existing native protocol remains public-flow authority |
