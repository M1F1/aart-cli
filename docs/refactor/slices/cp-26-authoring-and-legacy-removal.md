...
The one ordering constraint that survives is internal: step 6 precedes steps 8–9, because the
generator is written against the collected surface rather than against a transcription of it.
