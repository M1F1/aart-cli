...
from aart_cli.installation.io import (
    LocalInstallAdapter,
    _lock,
    _remove,
    _restore,
...
from aart_cli.installation.model import file_snapshot_digest
...
from aart_cli.store.model import ReferenceIndex, ReferenceKind, ReferenceReadRequest
