...
from aart_cli.install_state.model import InstallationRecord
from aart_cli.marketplace.catalog import ARTIFACT_AMBIGUOUS, resolve_artifact
from aart_cli.marketplace.model import ArtifactQuery, MarketplaceCatalog
        ...
        if not installed:
            diagnostics.append(
                Diagnostic(
                    ...
                    remediation=("aart-cli marketplace status",),
                )
            )
            continue
