...
that omits its source stays unbound here; :func:`aart_cli.marketplace.catalog.resolve_artifact`
...
from aart_cli.domain.identifiers import ArtifactIdentity, ArtifactKind, SourceAlias
