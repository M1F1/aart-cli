...
from aart_cli.application.removal_proposal import (
    PlannedRemoval,
    RemovalProposal,
    plan_removal,
    propose_removal,
...
from aart_cli.domain.receipts import InstalledRecord, PlacedArtifactReceipt
from aart_cli.domain.reconciliation import CurrentState, DesiredState
from aart_cli.domain.result import Err, Ok, Result
from aart_cli.domain.selection import OwnershipReason
