...
from aart_cli.domain.identifiers import ArtifactIdentity, ArtifactKind, ObjectDigest
from aart_cli.domain.result import Err, Ok, Result
from aart_cli.model import Err as SetupErr
from aart_cli.model import Ok as SetupOk
from aart_cli.model import SetupInstaller
from aart_cli.setup import custom_entrypoint_name, has_manual_setup_header, parse_installer
...
_DEPENDENCY_SCOPE_REMEDIATION = (
    ...
    "`aart-cli registry scan --help` and `aart-cli registry promote --help`, or copy the upstream content "
