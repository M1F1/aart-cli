...
MCP_SMOKE_REPORT_INVALID = DiagnosticCode("mcp-smoke-report-invalid")
AUTHOR_MANIFEST_INVALID = DiagnosticCode("author-manifest-invalid")
AUTHOR_MANIFEST_UNWRITABLE = DiagnosticCode("author-manifest-unwritable")
AUTHOR_PAYLOAD_INVALID = DiagnosticCode("author-payload-invalid")
AUTHOR_TREE_INVALID = DiagnosticCode("author-tree-invalid")
