...
from aart_cli.protocol.yaml import emit_yaml, parse_yaml
...
class CommentTest(unittest.TestCase):
    ...
    def test_a_header_comment_precedes_the_document(self) -> None:
        emitted = _emitted(self._DOCUMENT, comments={"": ("Generated by aart-cli author init.",)})

        self.assertTrue(emitted.startswith("# Generated by aart-cli author init.\nartifact:\n"))
