...
from aart_cli.application.reconciliation import plan_repair, repair_converged
...
from aart_cli.io.credentials import SECURITY_TOOL, MacOsKeychainProvider
...
def facts():
    ...
    return {
        ...
        "prefix": sys.prefix,
        "aart_importable": importlib.util.find_spec("aart_cli") is not None,
